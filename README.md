...
**Version 1.0.8** — Keeping work and home in sync, without the secrets.
...
|---|---|---|
| **1.0.8** *(latest)* | [HoneyDue-Calendar-Sync-1.0.8.dmg](https://github.com/007Style/honeydue-cal-sync/raw/main/build/HoneyDue-Calendar-Sync-1.0.8.dmg) | Fix: Dock icon appearing on macOS restart (added LSUIElement) |
| 1.0.7 | [HoneyDue-Calendar-Sync-1.0.7.dmg](https://github.com/007Style/honeydue-cal-sync/raw/main/build/HoneyDue-Calendar-Sync-1.0.7.dmg) | Fix: 15 min and 30 min sync intervals now work correctly |
...
1. Download **`HoneyDue-Calendar-Sync-1.0.8.dmg`** from the [Releases page](https://github.com/007Style/honeydue-cal-sync/releases/latest)
2. Open the DMG
...
- `build/HoneyDue-Calendar-Sync-1.0.8.dmg` — drag-to-install disk image
...
├── build/
│   ├── HoneyDue-Calendar-Sync-1.0.8.dmg # Drag-to-install disk image
│   ├── HoneyDue-Calendar-Sync-1.0.7.dmg # Previous release (kept for download history)
│   ├── HoneyDue-Calendar-Sync-1.0.6.dmg # Older release (kept for download history)
